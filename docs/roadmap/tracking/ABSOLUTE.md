...
**Pacote atual:** `2.13.0` (alpha.276) — **décima quarta e última fatia da fase 2.x (login screen)** — **FASE 2.x COMPLETA 14/14**.
...
- **Em produção (tagged, validated):** `2.13.0` (commit-side; tags externas pendentes). **Fase 1.x linear CONCLUÍDA + fase 2.x major CONCLUÍDA (14/14)**.
