...
```
https://github.com/<owner>/CapyUI/releases/download/v2.13.1/modules-index.txt
```
...
CapyOS first-boot releases should pin the index URL to a semver release tag, for example `https://github.com/<owner>/CapyUI/releases/download/v2.13.1/modules-index.txt`. This avoids an extra GitHub `latest` redirect during kernel-space module installation.
